"""Audio Transcription with Words event handlers."""
...
async def _handle_document_created(event: Event) -> None:
    ...
    Queues audio documents for transcription with word-level timestamps.
    ...
    # Queue transcription task with words
    celery_app.send_task(
        "audio_transcription_words.process",
        args=[document_id],
        queue="transcription",
    )
