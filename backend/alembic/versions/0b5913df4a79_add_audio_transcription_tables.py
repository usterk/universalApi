...
Revision ID: 0b5913df4a79
Revises: 27a18eff3966
Create Date: 2025-12-19 08:45:09.099307
...
revision: str = '0b5913df4a79'
down_revision: Union[str, None] = '27a18eff3966'
...
def upgrade() -> None:
    ...
    # Create transcription_words table
    op.create_table(
        'transcription_words',
        sa.Column('id', sa.UUID(), nullable=False),
